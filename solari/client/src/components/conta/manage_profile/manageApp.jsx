...
function ManageApp() {
return(
    <div className="p-6 text-white h-screen">
        <div className="text-[3vw] flex [&>img]:w-[4vw] cursor-default">
        ...
        <div className='flex flex-col justify-center items-center h-[90%]'>
            <div className='text-center [&>h1]:text-[3vw] [&>h4]:text-[1.5vw] [&>h4]:font-medium [&>h1]:font-bold'>
                ...
                <h4 className='text-zinc-500'>Select a profile to start streaming.</h4>
            </div>
