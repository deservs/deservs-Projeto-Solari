import { LogOut, UserRoundCog, Settings, Bookmark, MessageCircleQuestionMark } from "lucide-react";
    ...
    return (
      <div className="border-2 gap-6 pt-[1.5vh] border-zinc-700 w-xs h-[20vh] absolute top-14 right-0 bg-zinc-800 rounded-lg shadow-lg z-50 text-white text-[2vw] font-medium flex flex-col items-center">
        <h1>Entre para assistir</h1>
          <button onClick={() => link("/login")} className="flex items-center gap-5 border-2 text-[1.75vw] border-yellow-400 rounded-md p-2 text-yellow-400 cursor-pointer w-[80%] justify-center hover:bg-yellow-400 hover:text-black transition-colors">
